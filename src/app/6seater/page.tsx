...
// Main Function for Car Listing Page
function Morecares() {
  ...
  // Filter cars based on seating capacity between 3 and 7
  const filteredData = data.filter((car: Car) => {
    const seatingCapacity = parseInt(car.seating_capacity);
    return seatingCapacity > 5 && seatingCapacity < 7;
  });
